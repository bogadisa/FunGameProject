...
public class EditorScene extends Scene {
    ...
    public void init() {
        ...
        // AssetPool.getSpriteSheet("entities/player_3_3_9.png");

        // GameObject obj1 = new GameObject("Obj 1", new Transform().init(new
        // Vector3f(100, 100, -2), new Vector3f(256, 256, 1)));
        ...
        // GameObject obj2 = new GameObject("Obj 2", new Transform().init(new
        // Vector3f(300, 100, -1), new Vector3f(256, 256, 1)));
